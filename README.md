...
|[Prof. Jordan Boyd-Graber](http://users.umiacs.umd.edu/~jbg/)|[CLIP](https://wiki.umiacs.umd.edu/clip/index.php/Main_Page), University of Maryland (UMD)|Discover when individuals lie, reframe, or change the topic in a conversation; or to compete against humans in games that are based in natural language|[Link](https://scholar.google.com/citations?user=BT4XTP4AAAAJ) (4k+)|
|[Prof. Marine Carpuat](http://www.cs.umd.edu/~marine/)|[CLIP](https://wiki.umiacs.umd.edu/clip/index.php/Main_Page), University of Maryland (UMD)|Natural Language Processing, Semantics and Machine Translation|[Link](https://scholar.google.ca/citations?user=EAQfVXgAAAAJ) (3k+)|
|[Prof. Hal Daumé III](http://users.umiacs.umd.edu/~hal/)|[CLIP](https://wiki.umiacs.umd.edu/clip/index.php/Main_Page), University of Maryland (UMD)|Structured prediction, domain adaptation, unsupervised learning, multilingual modeling and affect analysis|[Link](https://scholar.google.com/citations?user=PbEw81gAAAAJ) (10k+)|
|[Prof. Naomi Feldman](http://users.umiacs.umd.edu/~nhf/index.html)|[CLIP](https://wiki.umiacs.umd.edu/clip/index.php/Main_Page), University of Maryland (UMD)|Computational psycholinguistics, statistics, machine learning, and automatic speech recognition|[Link](https://scholar.google.com/citations?user=FvRFQZ8AAAAJ) (~1k)|
|[Prof. Douglas W. Oard](http://terpconnect.umd.edu/~oard/)|[CLIP](https://wiki.umiacs.umd.edu/clip/index.php/Main_Page), University of Maryland (UMD)|eDiscovery, cross-language information retrieval and speech retrieval|[Link](https://scholar.google.com/citations?user=3ctKkysAAAAJ) (7k+)|
...
|[Prof. Dan Klein](https://people.eecs.berkeley.edu/~klein/)|[UCB NLP](http://nlp.cs.berkeley.edu/), University of California Berkeley (UCB)|Unsupervised language acquisition, Machine translation, Efficient algorithms for NLP, Information extraction, Linguistically rich models of language, Integrating symbolic and statistical methods for NLP, Historical linguistics||
...
|[Prof. William Y. Wang](http://www.cs.ucsb.edu/~william/)|[UCSB NLP](http://nlp.cs.ucsb.edu/index.html), University of California, Santa Barbara|Natural Language Processing, Information Extraction, Social Media, Language & Vision, Spoken Language Processing|[Link](https://scholar.google.com/citations?user=gf8Ms_8AAAAJ) (~1k)|
|[Prof. Mohit Bansal](http://www.cs.unc.edu/~mbansal/)|[UNC NLP](http://nlp.cs.unc.edu/), University of North Carolina Chapel Hill|Statistical natural language processing and machine learning, with a focus on multimodal, grounded, and embodied semantics (i.e., language with vision and speech, for robotics), human-like language generation and Q&A/dialogue, and interpretable and generalizable deep learning|[Link](https://scholar.google.com/citations?user=DN8QtscAAAAJ) (2k+)|
|[Prof. Greg Durrett](http://www.cs.utexas.edu/~gdurrett/)|University of Texas Austin (UTA)|Statistical natural language processing, including coreference resolution, entity linking, document summarization, and syntactic parsing|[Link](https://scholar.google.com/citations?user=EpQ_sDEAAAAJ) (~1k)|
|[Prof. Raymond J. Mooney](https://www.cs.utexas.edu/~mooney/)|University of Texas Austin (UTA)|NLP, Active Learning, Text Mining|[Link](https://scholar.google.com/citations?user=p9RsPG4AAAAJ) (31k+)|
|[Prof. Katrin Erk](http://www.katrinerk.com/)|University of Texas Austin (UTA)|Computational linguistics, focusing on semantics|[Link](https://scholar.google.com/citations?user=v7kFHRoAAAAJ) (3k+)|
|[Prof. Matthew Lease](https://www.ischool.utexas.edu/~ml/)|University of Texas Austin (UTA)|Information Retrieval, Crowdsourcing, Natural Language Processing|[Link](https://scholar.google.com/citations?user=qgmiQ5IAAAAJ) (3k+)|
|[Prof. ]()|||[Link]() ()|
